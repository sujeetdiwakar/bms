	...
	{	
		if(empty($_REQUEST['uid'])||empty($_REQUEST['pwd']))
			echo "<div class='alert alert-warning text-center'>
				...
				<strong>Warning!</strong> Username or Password is blank<br> <a href='index.php' class='alert-link'>Login</a>.
			 </div>";
		else
			echo "<div class='alert alert-warning text-center'>
			    <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
				<strong>Warning!</strong> Invalid User or Password<br> <a href='index.php' class='alert-link'>Login</a>.
			 </div>";	
	}
?>
</div>
