...
<?php
	...
	while($r = mysqli_fetch_object($row))
	{
		...
		echo"<td>$pub</td>";
		echo"<td>$price</td>";
		echo"<td><a title='Edit' class='text-success' href='edit_book.php?id=$id&list=edit'><i class='fa fa-pencil-square-o fa-lg'></i></a></td>";
		echo"<td><a title='Delete' class='text-danger' href='delete_book.php?id=$id'><i class='fa fa-trash-o fa-lg'></i></a></td>";
		echo"</tr>";
		//$sno++;
		if(empty($column)) 
		{
