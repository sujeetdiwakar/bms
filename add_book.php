<?php
		...
		if(empty($errors)){
			$q="INSERT INTO books(title,author,isbm,page,tchap,edition,pub,price) values('".$title."', '".$author."', '".$isbm."', '".$page."', '".$tchap."', '".$edition."', '".$pub."', '".$price."')";
				mysqli_query($conn, $q) or die($q);
				$success="saved <a href=add_chapters.php>Click Here add to chapter</a>";
						...
						<div class="row">
							<div class="col-lg-12">
								<form id="register-form" method="post" role="form">
									...
									<div class="form-group">
										<input type="text" name="page" value="<?php echo $page; ?>" tabindex="5" class="form-control" placeholder="Page">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
												<input type="submit" name="register-submit" id="register-submit" tabindex="6" class="form-control btn btn-register" value="Save Details">
